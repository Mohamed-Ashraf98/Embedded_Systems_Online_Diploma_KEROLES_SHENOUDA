# 1 ".\\ex6_macro_function_factory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".\\ex6_macro_function_factory.c"
...
# 2 ".\\ex6_macro_function_factory.c" 2
...
# 9 ".\\ex6_macro_function_factory.c"
int fun_mul_two(int x) { return (x*2) ; }
int fun_mul_three(int x) { return (x*3) ; }
